int sol() {
    ...
    // -------------------------
    Shader shader("resources/shaders/6.mirror.vs", "resources/shaders/6.mirror.fs");
    Shader skyboxShader("resources/shaders/6.vs", "resources/shaders/6.fs");
    ...
    std::cout << skyboxVBO << std::endl << cubeVBO;
